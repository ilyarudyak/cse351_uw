...
/* 1) Find a free block of the requested size in the free list.  Returns
...
/* 2) Insert freeBlock at the head of the list.  (LIFO) */
...
/* 3) Remove a free block from the free list. */
...
/* 4) Coalesce 'oldBlock' with any preceeding or following free blocks. */
...
/* 5) Get more heap space of size at least reqSize. */
...
/* B) Allocate a block of size size and return a pointer to it. */
...
/* C) Free the block referenced by ptr. */
